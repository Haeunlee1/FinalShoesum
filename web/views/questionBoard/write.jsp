...
<body>
    ...
    <form method="post" action="writeAction.jsp">
        <div id="write_container">
            <input type="text" name="write_title" id="write_title" placeholder="제목을 입력해주세요" required>
            <textarea name="write_contents" id="write_contents" placeholder="내용을 입력해주세요"></textarea>
        </div>
    ...
    <div id="write_bottom_container">
        <table id="write_password_container">
            <tr>
                ...
                <td><input type="password" class="password_table" name="content_pw" placeholder="4개의 숫자를 입력하세요." maxlength="4"></td>
            </tr>
        </table>
